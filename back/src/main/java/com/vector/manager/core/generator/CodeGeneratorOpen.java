package com.vector.manager.core.generator;
...
public class CodeGeneratorOpen {
    ...
    private PackageConfig buildPackageConfig(String moduleName) {
        ...
        packageConfig.setParent("com.unidt.insurance");
    ...
    private DataSourceConfig buildDataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://sh-cdb-2stkut2k.sql.tencentcdb.com:62863/insurance_marketing?useUnicode=true&characterEncoding=utf8&useSSL=false&tinyInt1isBit=false&allowPublicKeyRetrieval=true");
