...
//        templateConfig.setEntity("/generator/entity.java");
    ...
    private DataSourceConfig buildDataSourceConfig() {
        ...
        dataSourceConfig.setUrl("jdbc:mysql://localhost/longmarch?useUnicode=true&characterEncoding=utf8&useSSL=false&tinyInt1isBit=false&allowPublicKeyRetrieval=true");
